...
essentials:
  - icon: "🚌"
    label: "Getting There"
    value: "Buses from KL TBS (Bandar Tasik Selatan) depart every 30 minutes, 2 hours, RM10-15. Aerobus from KLIA directly to Malacca (2.5 hours, RM25). No train connection."
  - icon: "🚗"
    label: "Getting Around"
    value: "The historic core is fully walkable — Jonker Street, Dutch Square, and the hilltop fort area are all within 15 minutes on foot. Trishaws (decorated pedicabs) for a local experience. Grab for trips outside the heritage zone."
  - icon: "💰"
    label: "Daily Budget"
    value: "Budget: RM60-100 ($13-21). Mid-range: RM150-280 ($32-60). Malacca is cheaper than KL or Penang — accommodation is the main variable. Food at hawker prices: RM6-15 per meal."
  - icon: "🌡️"
    label: "Climate"
    value: "Tropical year-round (27-34°C). March to August is the drier period. October and November see heavier rainfall. No seasonal closures."
  - icon: "🏛️"
    label: "Heritage"
    value: "UNESCO World Heritage Site alongside Penang's George Town. Portuguese arrived 1511, Dutch 1641, British 1824. Three colonial layers in one compact historic core. All major sites are RM5-20 to enter."
highlights:
  - title: "Jonker Street Night Market"
    icon: "🏮"
    image: ""
  - title: "A Famosa Fort Ruins"
    icon: "🏰"
    image: ""
  ...
  - title: "Malacca River Cruise"
    icon: "🚤"
    image: ""
  - title: "Peranakan Food"
    icon: "🍲"
    image: ""
gradientColors: "from-red-900 via-red-700 to-orange-600"
relatedDestinations:
  - slug: kuala-lumpur
    videoSrc: ""
    hook: "Malaysia's capital — 2 hours north by bus, the full city contrast."
  - slug: penang
    videoSrc: ""
    hook: "Malaysia's other UNESCO heritage city — 5 hours north, very different character."
  - slug: johor-bahru
    videoSrc: ""
    hook: "2 hours south — gateway to Singapore and a city finding its feet."
affiliatePicks:
  - name: "Malacca Heritage Hotels"
    type: hotel
...
faqItems:
  - question: "Is Malacca worth visiting from Kuala Lumpur?"
    answer: "Yes — Malacca is one of the most rewarding day trips or overnight stops from KL. The 2-hour bus from KL TBS is easy and cheap (RM10-15). The historic core is compact enough to cover in a full day. An overnight allows you to do Jonker Street Night Market on Friday or Saturday evening, which is the social highlight of Malacca."
  - question: "How many days do you need in Malacca?"
    answer: "One full day covers the heritage highlights — A Famosa fort, St Paul's Hill, Dutch Square, Baba-Nyonya Heritage Museum, and a trishaw ride. Two days adds the Malacca River cruise, deeper Peranakan food exploration, and time to browse the antique shops on Jonker Street without rushing. The Jonker Street Night Market runs Friday and Saturday evenings — time your visit around this."
  - question: "What is Peranakan culture in Malacca?"
