...
budgetPerDay:
  ...
  midRange: 55
  luxury: 150
gettingThere: "Fly into Penang International (PEN) — 45-minute flight from KL. Or take the KTM train to Butterworth and the 10-minute ferry across to George Town (RM1.20)."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Fly into Penang International (PEN) — AirAsia and Malaysia Airlines daily from KL (45 min). Or KTM ETS train to Butterworth + ferry to George Town."
  - icon: "🚶"
    label: "Getting Around"
    value: "George Town heritage core is fully walkable. Free CAT bus along main streets. Grab for cross-island trips and Penang Hill. Bicycle rentals in George Town from RM15/day."
  - icon: "💰"
    label: "Daily Budget"
