...
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Kota Kinabalu International Airport (BKI) — AirAsia and Malaysia Airlines from KL (2.5 hrs, from RM150 one-way). Direct flights from Singapore, Manila, Taipei, and Chinese cities. No train access to Sabah."
  - icon: "🚗"
    label: "Getting Around"
    value: "KK city centre is walkable. Grab for wider city trips. Minivans from Padang Merdeka for destinations like Kundasang (Kinabalu Park) — RM20-30. Rent a car for independent Sabah travel (RM60-100/day)."
  - icon: "💰"
    label: "Daily Budget"
    value: "Budget: RM80-130 ($17-28). Mid-range: RM200-400 ($43-85). Slightly more expensive than Peninsula Malaysia due to East Malaysia transport premiums. Seafood at the waterfront market is excellent value."
  - icon: "🌡️"
    label: "Climate"
    value: "Tropical year-round (27-33°C). March to October is the drier period. Wet season (November-February) brings heavy rain but not monsoon-level closures like the east coast islands."
  - icon: "🏔️"
    label: "Mount Kinabalu"
    value: "Southeast Asia's highest peak (4,095m) is 2 hours by minivan from KK. Summit permits book out 3-6 months in advance. Book through Sutera Sanctuary Lodges online before arrival."
highlights:
  - title: "Tunku Abdul Rahman Marine Park"
    icon: "🏝️"
    image: ""
  - title: "Mount Kinabalu Sunrise"
    icon: "🏔️"
    image: ""
  - title: "Filipino Market Night Seafood"
    icon: "🦞"
    image: ""
  - title: "Signal Hill Observatory"
    icon: "🌆"
    image: ""
  - title: "Sabah State Museum"
    icon: "🏛️"
    image: ""
  - title: "Kinabalu Park Wildlife"
    icon: "🦜"
    image: ""
gradientColors: "from-blue-900 via-teal-700 to-cyan-600"
relatedDestinations:
  - slug: sandakan
    videoSrc: ""
    hook: "1-hour flight east — orangutans, the Kinabatangan River, and Borneo wildlife."
  - slug: kuching
    videoSrc: ""
    hook: "1.5-hour flight to Sarawak — orangutans, proboscis monkeys, and Bako National Park."
  - slug: mulu
    videoSrc: ""
    hook: "Connect via Miri — UNESCO World Heritage caves and the bat exodus."
affiliatePicks:
  - name: "Kota Kinabalu Hotels"
    type: hotel
...
faqItems:
  - question: "How do I climb Mount Kinabalu?"
    answer: "Mount Kinabalu summit climbs are managed through Sutera Sanctuary Lodges (kinabalu-park.com). You must book 3-6 months in advance — permits and accommodation at Laban Rata (the overnight shelter at 3,270m) sell out fast. The standard summit climb is two days: arrive at the park on day 1, sleep at Laban Rata, summit attempt before dawn on day 2, descend by noon. Total cost: RM1,200-1,500+ per person including park fees, guide (mandatory), and accommodation."
  - question: "What is the Tunku Abdul Rahman Marine Park?"
    answer: "Five islands just 15-20 minutes by speedboat from the KK waterfront, forming a protected marine park with clear water, coral reefs, and white sand beaches. Sapi and Manukan are the most developed with snorkeling gear rental, water sports, and chalets. Mamutik is quieter. Day trips RM25-35/person by boat. Snorkel gear rental RM15-20. Best February to October; rougher in November and December."
...
- **Mid-Range (RM200-450/night, $43-95)** — City centre hotels with waterfront access. [Le Meridien Kota Kinabalu](https://www.booking.com/searchresults.html?ss=Le+Meridien+Kota+Kinabalu&aid=2778866) is the most reliable upscale city option (RM350-500/night). [Hyatt Regency Kinabalu](https://www.booking.com/searchresults.html?ss=Hyatt+Regency+Kinabalu&aid=2778866) offers comparable quality.
- **Luxury (RM600-2,000+/night, $128-425+)** — The [Shangri-La Rasa Ria](https://www.booking.com/searchresults.html?ss=Shangri-La+Rasa+Ria+Kota+Kinabalu&aid=2778866) 30 minutes north of KK, with its own beach and orangutan conservation program, is the standout luxury resort in Sabah.
...
<div class="scott-tips">
  ...
  <ul>
    <li><strong>Getting There:</strong> AirAsia from KL is the cheapest option (book 4-6 weeks ahead from RM100 one-way). Malaysia Airlines is faster to book but pricier. No overland connection from Peninsula Malaysia to Sabah — this is a flight-required destination.</li>
    <li><strong>Best Time to Visit:</strong> March-October is the drier period. For Mount Kinabalu summit, February and March have the best visibility but book permits 3-6 months ahead regardless of month. Kaamatan festival in May is a great time to experience Sabahan culture.</li>
    <li><strong>Getting Around:</strong> Walk the city centre. Grab for Signal Hill and the museum. Minivans from Padang Merdeka for Kinabalu Park (RM20-25 each way). Rent a car only if doing a multi-day Sabah road trip.</li>
    <li><strong>Money & ATMs:</strong> Good ATM coverage in the city centre. Slightly more expensive than Peninsula Malaysia — budget RM100-150/day for food and local transport. Seafood at the waterfront market is cheaper than it looks when you negotiate the price per 100g before cooking.</li>
    <li><strong>Safety & Health:</strong> Safe city. Watch belongings in busy market areas. Queen Elizabeth Hospital is the main public hospital; Sabah Medical Centre for private care. Travel insurance is essential for Kinabalu summit climbs.</li>
    <li><strong>Packing Essentials:</strong> For KK city: light tropicals and walking shoes. For Kinabalu summit: full hiking gear including warm layers (summit temperature 0-5°C), waterproof jacket, headlamp, and trekking poles. Snorkel gear for the marine park (or rent RM15-20 on the island).</li>
    <li><strong>Local Culture & Etiquette:</strong> Sabah has over 30 indigenous ethnic groups — the Kadazan-Dusun, Bajau, and Murut being the largest. Be respectful at longhouse visits if arranged through guides. The Gaya Street Sunday market is a genuine community event, not a tourist show.</li>
  </ul>
</div>

<EmailCapture
  leadMagnet="Get Our Free Kota Kinabalu Travel Guide"
  description="The complete KK and Sabah guide — marine park islands, Mount Kinabalu planning, and Borneo wildlife."
  bullets={[
    'Mount Kinabalu summit guide — booking permits, what to expect, and how to prepare',
    'Marine park island hopping — which islands for snorkeling, beaches, and crowds',
    'Sabah wildlife calendar — best months for orangutans, pygmy elephants, and proboscis monkeys',
    'Three-day and five-day Sabah itineraries with prices',
  ]}
  guideTag="destination-kota-kinabalu"
/>
