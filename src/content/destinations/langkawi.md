...
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Langkawi International Airport (LGK) — AirAsia and Malaysia Airlines daily from KL (1 hr). High-speed ferry from Penang Swettenham Pier takes 2.5 hours (RM70 one-way, RM120 return)."
  - icon: "🚗"
    label: "Getting Around"
    value: "You need a car or scooter — Langkawi has no public transport. Car rental from RM60/day, scooter from RM35/day at the airport or Kuah jetty. Grab operates on the island."
  - icon: "💰"
    label: "Daily Budget"
    value: "Budget: RM80-120 ($17-26). Mid-range: RM200-400 ($43-85). Langkawi is duty-free — alcohol and chocolate are substantially cheaper than mainland Malaysia."
  - icon: "🌡️"
    label: "Climate"
    value: "Tropical year-round (27-33°C). Dry season November to April — the prime beach season. July to September brings rougher seas and island-hopping tours may be cancelled."
  - icon: "🏝️"
    label: "Duty-Free"
    value: "Langkawi is a designated duty-free island. Alcohol, chocolate, and cosmetics are sold at significantly reduced prices. Grab a bottle of wine at 7-Eleven for less than RM20."
highlights:
  - title: "Langkawi Cable Car & Sky Bridge"
    icon: "🚡"
    image: ""
  ...
  - title: "Duty-Free Shopping"
    icon: "🛒"
    image: ""
gradientColors: "from-cyan-900 via-teal-700 to-emerald-600"
relatedDestinations:
  - slug: penang
    videoSrc: ""
    hook: "2.5 hours by ferry — Malaysia's food capital and UNESCO heritage city."
  - slug: kuala-lumpur
    videoSrc: ""
    hook: "1-hour flight to the capital — the full city contrast."
  - slug: perhentian-islands
    videoSrc: ""
    hook: "East coast snorkeling paradise — open March to October."
affiliatePicks:
  - name: "Langkawi Beachfront Hotels"
    type: hotel
...
faqItems:
  - question: "What is the best time to visit Langkawi?"
    answer: "November to April is the dry season — calm seas, good visibility, and beach weather. December and January are peak season with the best conditions but higher prices. July to September brings rougher weather and island-hopping tours are frequently cancelled. Langkawi is the only major Malaysian island that stays accessible year-round — the east coast islands (Perhentians, Tioman) close completely from November to February."
  - question: "Do I need a car in Langkawi?"
    answer: "Yes. Langkawi has no public bus or taxi system worth relying on. Rent a car from the airport or Kuah jetty (from RM60/day) or a scooter (from RM35/day). Grab operates on the island but availability can be patchy in less touristy areas. The main road circuits the island — it's easy driving."
  - question: "Is Langkawi good for families?"
