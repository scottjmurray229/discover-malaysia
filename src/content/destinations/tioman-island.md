...
budgetPerDay:
  ...
  midRange: 100
  luxury: 250
gettingThere: "Ferry from Mersing (2 hours, RM35-70 one way) or from Tanjung Gemok (1.5 hours, RM35). The island is closed from November to February during the northeast monsoon."
essentials:
  - icon: "⛴️"
    label: "Getting There"
    value: "Ferry from Mersing jetty (2 hours, RM35-70) or Tanjung Gemok (1.5 hours, RM35). Mersing is reached by bus from KL (3.5 hours) or JB (2.5 hours). AirAsia flies to Tioman Airport (TOD) from KL in peak season."
  - icon: "🚤"
    label: "Getting Around"
    value: "Water taxis connect Tioman's five main beach villages — Tekek (main jetty), Salang, Air Batang (ABC), Juara, and Mukut. RM10-20 between villages. Walking jungle trail connects Tekek to Juara (east coast) over the central mountains — 7km, 3-4 hours."
  - icon: "💰"
    label: "Daily Budget"
    value: "Budget: RM100-150 ($21-32, guesthouse + meals + snorkel gear). Mid-range: RM250-400 ($53-85). Diving adds RM130-180 per dive. Tioman is more expensive than the mainland but dive quality justifies the premium."
  - icon: "🌡️"
    label: "Climate"
    value: "Open March to October. CLOSED November to February (northeast monsoon). Seas in the closed season make ferry crossings dangerous and the island empties completely. Peak season is July-August."
  - icon: "🤿"
    label: "Diving"
    value: "Tioman is in the top 10 dive destinations in Asia. Visibility to 20m. Coral at relatively shallow depths (5-25m). Leopard sharks, schools of barracuda, reef sharks, and turtles are regularly sighted. PADI Open Water course available from RM850-1,200."
highlights:
  - title: "Coral Reef Diving"
    icon: "🤿"
    image: ""
  - title: "Monkey Bay Beach"
    icon: "🏖️"
    image: ""
  - title: "Jungle Trek to Juara"
    icon: "🌿"
    image: ""
  - title: "Salang Snorkeling"
    icon: "🐠"
    image: ""
  - title: "Sunset at ABC Beach"
    icon: "🌅"
    image: ""
...
relatedDestinations:
  - slug: perhentian-islands
    videoSrc: ""
    hook: "The other great dive island — east coast, same season, slightly better snorkeling."
  - slug: langkawi
    videoSrc: ""
    hook: "West coast island open year-round — great if visiting outside dive season."
  - slug: kuala-lumpur
    videoSrc: ""
    hook: "3.5 hours to the ferry — KL is the main gateway for Tioman."
affiliatePicks:
  - name: "Tioman Island Chalets and Dive Resorts"
    type: hotel
...
faqItems:
  - question: "When is Tioman Island open?"
    answer: "Tioman is open March to October. The island closes completely during the northeast monsoon (November to February) when the South China Sea becomes too rough for ferry crossings and most accommodation shuts. Plan your visit entirely within the March-October window. July and August are peak season."
  - question: "Is Tioman good for beginners to diving?"
    answer: "Excellent for beginners. The visibility is high (15-20m when conditions are good), the coral is at shallow depths (5-15m for most beginner dives), and the current is generally mild. Multiple PADI-certified dive operators in ABC, Salang, and Tekek offer Open Water courses (3-4 days, RM850-1,200 including all dives). The warm water (27-29°C) makes extended dive time comfortable without a full wetsuit."
  - question: "Which village should I stay in on Tioman?"
