...
essentials:
  - icon: "⛴️"
    label: "Getting There"
    value: "Bus from KL TBS or Puduraya to Kuala Besut (5-6 hours, RM35-50). Speedboat from Kuala Besut jetty to the islands (30-40 min, RM70 return). Or fly to Kota Bharu (KBR), then 45-min taxi to Kuala Besut (RM60-80)."
  - icon: "🚤"
    label: "Getting Around"
    value: "Speedboats run between Perhentian Besar (Long Beach, Coral Bay) and Perhentian Kecil (Pasir Panjang) from morning to late afternoon. RM10-15 per crossing. Swimming between bays on the same island is possible but watch for boat traffic."
  - icon: "💰"
    label: "Daily Budget"
    value: "Budget: RM100-160 ($21-34, guesthouse + meals + snorkel gear). Mid-range: RM250-450 ($53-95). Diving adds RM130-200 per dive. The Perhentians are slightly cheaper than Tioman. Backpacker accommodation from RM40/night on Kecil."
  - icon: "🌡️"
    label: "Climate"
    value: "Open March to October. CLOSED November to February (northeast monsoon). During the monsoon, the islands are inaccessible and most accommodation closes. Peak season is June-August with the calmest seas and best visibility."
  - icon: "🐢"
    label: "Turtles"
    value: "Green and hawksbill turtles nest on the Perhentians and are sighted year-round while snorkeling — Turtle Beach on Besar and the waters around Kecil are the most reliable spots. Swimming alongside them (at distance, without chasing) is a regular Perhentian experience."
highlights:
  - title: "Sea Turtle Snorkeling"
    icon: "🐢"
    image: ""
  - title: "Shark Point Diving"
    icon: "🦈"
    image: ""
  - title: "Long Beach, Perhentian Kecil"
    icon: "🏖️"
    image: ""
  - title: "Coral Bay"
    icon: "🐠"
    image: ""
  - title: "Island Hopping by Speedboat"
    icon: "⛵"
    image: ""
  - title: "Bioluminescent Night Swim"
    icon: "✨"
    image: ""
gradientColors: "from-cyan-900 via-blue-700 to-indigo-600"
relatedDestinations:
  - slug: tioman-island
    videoSrc: ""
    hook: "Malaysia's other great dive island — same season, volcanic peaks and jungle trails."
  - slug: langkawi
    videoSrc: ""
    hook: "West coast island open year-round — great if visiting outside dive season."
  - slug: kuala-lumpur
    videoSrc: ""
    hook: "5-6 hours by bus — KL is the main gateway to the Perhentians."
affiliatePicks:
  - name: "Perhentian Islands Chalets and Dive Resorts"
    type: hotel
...
faqItems:
  - question: "When can I visit the Perhentian Islands?"
    answer: "The Perhentians are open March to October. The island closes completely during the northeast monsoon (November to February) — accommodation shuts, the jetty at Kuala Besut stops operating, and the seas are too dangerous for the speedboat crossing. The best time to visit is April to August when seas are calmest and visibility is highest (15-20m). July and August are peak season — book well in advance."
  - question: "Which is better — Perhentian Besar or Kecil?"
    answer: "Kecil (the small island) suits backpackers and budget travelers: Long Beach has the widest choice of budget accommodation, the most social atmosphere, and the most dive schools. Besar (the big island) has better mid-range resorts, quieter beaches, and Turtle Beach — the most reliable spot for sea turtle encounters while snorkeling. Many visitors stay on Kecil for the social scene and take a water taxi to Besar for snorkeling."
  - question: "Can I see turtles at the Perhentian Islands?"
