...
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Sandakan Airport (SDK) — MASWings from KK (1 hour, RM80-120) or direct from KL (2.5 hours, from RM150). Bus from KK takes 5-6 hours (RM35-50) along the Sabah highway — scenic but long."
  - icon: "🚗"
    label: "Getting Around"
    value: "Sandakan town is a base — you need transport to reach Sepilok (25 min) and Kinabatangan (2.5 hours). Grab exists but is limited. Most wildlife lodges provide transfers. Rent a car or use lodge transport for flexibility."
  - icon: "💰"
    label: "Daily Budget"
    value: "Budget: RM100-160 ($21-34). Mid-range: RM280-450 ($60-95). Wildlife experiences in Borneo cost more than peninsula Malaysia — lodge packages on the Kinabatangan River are RM200-600/night including meals and river cruises."
  - icon: "🌡️"
    label: "Climate"
    value: "Tropical year-round (27-34°C). March to October is generally drier and better for wildlife viewing. Kinabatangan River wildlife is most concentrated during dry season when water levels drop."
  - icon: "🦧"
    label: "Wildlife"
    value: "Sandakan district has the highest density of accessible wildlife in Borneo: Sepilok orangutans (25 min from town), Sun Bear Conservation Centre (25 min), and Kinabatangan River (2.5 hours) for proboscis monkeys, pygmy elephants, and wild orangutans."
highlights:
  - title: "Sepilok Orangutan Rehabilitation"
    icon: "🦧"
    image: ""
  - title: "Kinabatangan River Safari"
    icon: "🐊"
    image: ""
  - title: "Sun Bear Conservation Centre"
    icon: "🐻"
    image: ""
  - title: "Turtle Islands Park"
    icon: "🐢"
    image: ""
  - title: "Proboscis Monkey Sighting"
    icon: "🐒"
    image: ""
  - title: "Gomantong Caves"
    icon: "🦇"
    image: ""
gradientColors: "from-green-900 via-emerald-800 to-lime-700"
relatedDestinations:
  - slug: kota-kinabalu
    videoSrc: ""
    hook: "1-hour flight west — Sabah's capital and base for Mount Kinabalu."
  - slug: kuching
    videoSrc: ""
    hook: "Connect via KL or KK — Sarawak's wildlife and cave destinations."
  - slug: mulu
    videoSrc: ""
    hook: "Connect via Miri — UNESCO caves and the world's largest bat exodus."
affiliatePicks:
  - name: "Kinabatangan River Wildlife Lodges"
    type: hotel
...
faqItems:
  - question: "How do I see orangutans in Sandakan?"
    answer: "Sepilok Orangutan Rehabilitation Centre (25 minutes from Sandakan town) has semi-wild orangutans that return to the feeding platforms twice daily — 10am and 3pm. Entrance RM30. For truly wild orangutans, the Kinabatangan River gives the best chance: guides know the ranging areas and orangutans are commonly spotted in riverside trees. A 2-night Kinabatangan package gives you 4 river cruises (2 dawn, 2 dusk) — maximum exposure."
  - question: "What is the Kinabatangan River?"
    answer: "The Kinabatangan is Sabah's longest river and Malaysia's finest wildlife corridor. A protected strip of forest along the river banks shelters proboscis monkeys, Bornean pygmy elephants (world's smallest elephant subspecies), saltwater crocodiles, several hornbill species, wild orangutans, and macaque monkeys all within a few kilometers. Dawn and dusk river cruises by boat are the standard way to see wildlife. The river lodges at Bilit and Sukau provide accommodation and guided cruises."
  - question: "What is the Sun Bear Conservation Centre?"
