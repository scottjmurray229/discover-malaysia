...
budgetPerDay:
  ...
  midRange: 55
  luxury: 130
gettingThere: "Bus from KL Puduraya or TBS takes 3.5-4 hours (RM20-30). Or take the ETS train to Ipoh and connect by bus (1 more hour). No direct train to Cameron Highlands."
essentials:
  - icon: "🚌"
    label: "Getting There"
    value: "Direct buses from KL TBS (3.5-4 hours, RM20-30) or from Ipoh (1.5 hours, RM10). Destinations in the highlands are spread across Ringlet, Tanah Rata, Brinchang — Tanah Rata is the main hub for travellers."
  - icon: "🚗"
    label: "Getting Around"
    value: "Tanah Rata town is walkable. Hired taxis for plantation and farm tours (RM60-120 half day). Grab is unreliable in the highlands — arrange a local taxi through your accommodation."
  - icon: "💰"
    label: "Daily Budget"
    value: "Budget: RM60-100 ($13-21). Mid-range: RM150-280 ($32-60). Cheaper than the coast — food is inexpensive, accommodation ranges from RM40 hostel dorms to RM300 for a highland hotel room."
  - icon: "🌡️"
    label: "Climate"
    value: "Cool and misty year-round — 15-25°C day, down to 10-13°C at night in December and January. Pack layers. Afternoon mist and light rain is common; full rain mostly April-May and October-November."
  - icon: "🌿"
    label: "Altitude"
    value: "Tanah Rata sits at 1,524m above sea level. The cool air is the reason people come — a 10°C drop from the lowlands is instantly noticeable. Bring a fleece or light jacket regardless of the month."
highlights:
  - title: "BOH Tea Plantation"
    icon: "🍵"
    image: ""
  - title: "Mossy Forest Trail"
    icon: "🌿"
    image: ""
  - title: "Strawberry Farms"
    icon: "🍓"
    image: ""
  - title: "Tanah Rata Market"
    icon: "🏪"
    image: ""
  - title: "Sam Poh Temple"
    icon: "🕌"
    image: ""
  - title: "Cameron Highlands Butterflies"
    icon: "🦋"
    image: ""
gradientColors: "from-green-900 via-green-700 to-emerald-500"
relatedDestinations:
  - slug: kuala-lumpur
    videoSrc: ""
    hook: "3.5 hours by bus — Malaysia's capital is the gateway in and out."
  - slug: ipoh
    videoSrc: ""
    hook: "1.5 hours downhill — Malaysia's best food city, great food stop en route."
  - slug: penang
    videoSrc: ""
    hook: "4 hours north via Ipoh — UNESCO heritage and the best hawker food in Malaysia."
affiliatePicks:
  - name: "Cameron Highlands Hotels & Guesthouses"
    type: hotel
    price: "RM40-400/night ($9-85)"
    personalNote: "Stay in Tanah Rata for the widest choice and walking access to restaurants and the bus station. Brinchang is closer to the tea plantations but has fewer options. Budget guesthouses from RM40/night, mid-range hotels with views from RM150-300/night."
    affiliateUrl: "https://www.booking.com/searchresults.html?ss=Cameron+Highlands+Tanah+Rata+Hotel&aid=2778866"
    badge: "Book on Booking.com"
faqItems:
  - question: "What is Cameron Highlands famous for?"
    answer: "Cameron Highlands is Malaysia's premier hill station — famous for its BOH tea plantations (one of the largest tea gardens in Southeast Asia), strawberry farms, cool climate, and mossy forest trails. It was developed as a colonial retreat by British administrator William Cameron in 1885. Today it's the primary destination for Malaysians and visitors wanting relief from the lowland heat, with temperatures 10-15°C cooler than KL or Penang."
  - question: "How do I get to Cameron Highlands from Kuala Lumpur?"
    answer: "Direct express buses from KL TBS (Bandar Tasik Selatan) to Tanah Rata take 3.5-4 hours and cost RM20-30. Buses depart from early morning until early afternoon — book in advance for weekend departures. Alternatively, take the ETS train to Ipoh (2 hours) and connect by bus to Cameron Highlands (1.5 hours, RM10). No direct train service to the Highlands."
  - question: "What should I do in Cameron Highlands?"
...
- **Mid-Range (RM150-350/night, $32-74)** — Heritage-style bungalows and highland resort hotels. The [Cameron Highlands Resort](https://www.booking.com/searchresults.html?ss=Cameron+Highlands+Resort&aid=2778866) (managed by YTL Hotels) is the best luxury-to-mid-range property — colonial bungalow in landscaped gardens, RM500-800/night but often discounted.
- **Guesthouses with Character (RM120-250/night, $26-53)** — Search for highland bungalows and family-run guesthouses in Tanah Rata on [Booking.com](https://www.booking.com/searchresults.html?ss=Cameron+Highlands+Tanah+Rata&aid=2778866) — some of the best value accommodation in Malaysia.
...
<div class="scott-tips">
  ...
  <ul>
    <li><strong>Getting There:</strong> Bus from KL TBS is the standard. Book the Konsortium or Aeroline bus in advance for weekend departures — they fill up completely Friday afternoons as KL residents escape. First bus from KL arrives Tanah Rata around 10am.</li>
    <li><strong>Best Time to Visit:</strong> March-May and August-October have the best weather balance — cool but not as wet as November. Avoid school holiday weeks (June and December) when the Highlands get extremely crowded and accommodation triples in price.</li>
    <li><strong>Getting Around:</strong> Tanah Rata is walkable. For the BOH plantation and Gunung Brinchang, arrange a half-day taxi tour through your guesthouse (RM60-120). Grab barely works in the highlands — don't rely on it.</li>
    <li><strong>Money & ATMs:</strong> ATMs in Tanah Rata main town. The Highlands are cash-heavy — many farms, stalls, and smaller restaurants don't take card. Bring RM200-300 cash for a two-night stay.</li>
    <li><strong>Safety & Health:</strong> Very safe. Altitude means sun is stronger than at the coast — use sunscreen even on cloudy days. The jungle trails are easy to get lost on — stick to marked trails or go with a guide. Medical: Hospital Orang Asli in Gombak handles serious emergencies; Tanah Rata clinic for minor issues.</li>
    <li><strong>Packing Essentials:</strong> A fleece or light jacket (non-negotiable — nights can hit 13°C), waterproof layer, walking shoes with grip for muddy jungle trails, and long trousers for the mossy forest. Sunscreen still needed — UV is strong at altitude.</li>
    <li><strong>Local Culture & Etiquette:</strong> Cameron Highlands has a significant Orang Asli (indigenous Malaysian) community. If visiting their villages or roadside stalls, purchase their honey and rattan products — it's direct economic support. Don't photograph without asking.</li>
  </ul>
</div>

<EmailCapture
  leadMagnet="Get Our Free Cameron Highlands Travel Guide"
  description="Everything you need for Cameron Highlands — tea plantations, mossy forest, and the best highland food."
  bullets={[
    'BOH Plantation guide — which estate to visit, what to order at the café',
    'Mossy forest and Gunung Brinchang trail — what to expect and how to get there',
    'Best strawberry farms and what to buy beyond fresh fruit',
    'Two-day Cameron Highlands itinerary with bus connections from KL and Penang',
  ]}
  guideTag="destination-cameron-highlands"
/>
