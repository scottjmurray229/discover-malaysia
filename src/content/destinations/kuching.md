...
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Kuching International Airport (KCH) — Malaysia Airlines and AirAsia from KL (1.5 hours, from RM100). Direct from Singapore (Scoot, 1.5 hours), Johor Bahru (AirAsia), and KK (1 hour, MASWings)."
  - icon: "🚗"
    label: "Getting Around"
    value: "Kuching waterfront and Old Town are walkable. Grab is reliable throughout the city. Minibus or Grab to Semenggoh (25 min) and Bako National Park (45 min to jetty + 30 min boat). Car rental from RM60/day."
  - icon: "💰"
    label: "Daily Budget"
    value: "Budget: RM80-130 ($17-28). Mid-range: RM180-350 ($38-74). Cheaper than KK with a wider range of food options. Kolo mee breakfast costs RM5-8; a full hawker lunch RM12-20."
  - icon: "🌡️"
    label: "Climate"
    value: "Tropical year-round (25-33°C). Sarawak receives the most rainfall of any Malaysian state — expect afternoon showers throughout the year. March to October is drier; November and December are wetter."
  - icon: "🏛️"
    label: "Museums"
    value: "Kuching has the best museum network in Malaysia outside KL. The Sarawak Museum (opened 2022, RM30) covers indigenous culture, natural history, and colonial history in extraordinary depth. Allow a full day."
highlights:
  - title: "Semenggoh Orangutan Centre"
    icon: "🦧"
    image: ""
  ...
  - title: "Kuching Waterfront"
    icon: "🌊"
    image: ""
  - title: "Kolo Mee at a Kopitiam"
    icon: "🍝"
    image: ""
  - title: "Iban Longhouse Visit"
    icon: "🏡"
    image: ""
gradientColors: "from-yellow-900 via-amber-700 to-orange-600"
relatedDestinations:
  - slug: mulu
    videoSrc: ""
    hook: "1-hour flight via Miri — UNESCO World Heritage caves and the bat exodus."
  - slug: kota-kinabalu
    videoSrc: ""
    hook: "1.5-hour flight to Sabah — Mount Kinabalu and the Kinabatangan wildlife corridor."
  - slug: sandakan
    videoSrc: ""
    hook: "Connect via KL or KK — the Kinabatangan River and Sepilok orangutans."
affiliatePicks:
  - name: "Kuching Waterfront Hotels"
    type: hotel
...
faqItems:
  - question: "What is kolo mee and where do I eat it in Kuching?"
    answer: "Kolo mee is Kuching's signature noodle dish — thin egg noodles tossed in a light dressing of pork lard, soy sauce, and sesame oil, topped with minced pork, char siu (BBQ pork), and crispy fried shallots. It's served at room temperature, never hot. Every kopitiam in Kuching serves it, especially for breakfast. The best versions are found at neighborhood coffee shops in the suburbs, but the kopitiams along Jalan Carpenter and the Old Town area are excellent starting points. RM5-8/plate."
  - question: "Is Bako National Park worth visiting?"
    answer: "Absolutely — Bako is one of the most biodiverse parks per square kilometer in all of Malaysia. The park protects 7 distinct types of vegetation including coastal cliff forest, mangroves, and kerangas (heath forest). Proboscis monkeys, bearded pigs, long-tailed macaques, and silver leaf monkeys are commonly spotted near the park headquarters. The carnivorous pitcher plant (Nepenthes) grows along the trails in extraordinary variety. Day trips are possible but an overnight lets you experience the park at its quietest."
  - question: "How do I visit Semenggoh Orangutan Centre?"
