...
budgetPerDay:
  ...
  midRange: 55
  luxury: 140
gettingThere: "ETS train from KL Sentral to JB Sentral takes 4.5 hours (RM60-80). Or 5 hours by bus (RM30-40). From Singapore, cross the Causeway by bus (RM3-5, 30-60 minutes depending on traffic)."
essentials:
  - icon: "🚂"
    label: "Getting There"
    value: "KTM ETS train from KL Sentral to JB Sentral (4.5 hours, RM60-80). Bus from KL TBS to JB (5 hours, RM30-40). From Singapore, SBS Transit or SMRT buses cross the Causeway (RM3-5, 30-90 min depending on queue)."
  - icon: "🚗"
    label: "Getting Around"
    value: "JB city centre is navigable by Grab (RM10-25). The Medini area and LEGOLAND require transport. Crossing to Singapore: Causeway bus or Rapid KL CW1 bus from JB Sentral. Driving is popular for families crossing into Woodlands."
  - icon: "💰"
    label: "Daily Budget"
    value: "Budget: RM60-100 ($13-21). Mid-range: RM140-280 ($30-60). JB's main value is relative to Singapore — meals and accommodation at 40-60% of Singapore prices. Singaporeans cross specifically for cheap food."
  - icon: "🌡️"
    label: "Climate"
    value: "Hot and humid year-round (27-34°C). Slightly drier January-March and July-September. Southern Johor receives afternoon showers regularly but no monsoon closures like the east coast."
  - icon: "🇸🇬"
    label: "Singapore Proximity"
    value: "JB sits directly across the Causeway from Singapore (1km). Many travelers use JB as a cheap accommodation base for Singapore visits. Day trips from JB to Singapore are straightforward by Causeway bus."
highlights:
  - title: "Causeway Day Trip to Singapore"
    icon: "🇸🇬"
    image: ""
  - title: "LEGOLAND Malaysia"
    icon: "🧱"
    image: ""
  - title: "Arulmigu Sri Rajakaliamman Temple"
    icon: "🕌"
    image: ""
  - title: "JB Old Market Square"
    icon: "🏛️"
    image: ""
  - title: "Komtar JBCC Shopping"
    icon: "🛍️"
    image: ""
  - title: "Street Food at Jalan Wong Ah Fook"
    icon: "🍜"
    image: ""
gradientColors: "from-blue-900 via-blue-700 to-sky-600"
relatedDestinations:
  - slug: malacca
    videoSrc: ""
    hook: "2 hours north by bus — Malaysia's UNESCO heritage city."
  - slug: kuala-lumpur
    videoSrc: ""
    hook: "4.5 hours north by train — the capital and main gateway."
  - slug: tioman-island
    videoSrc: ""
    hook: "3 hours to Mersing ferry — Malaysia's best dive island (open March-October)."
affiliatePicks:
  - name: "Johor Bahru Hotels"
    type: hotel
...
faqItems:
  - question: "Is it worth staying in Johor Bahru instead of Singapore?"
    answer: "Yes, if budget is a consideration. Hotel prices in JB are 40-60% of equivalent Singapore options. Meals at JB hawker stalls cost RM8-15 versus SGD15-25 in Singapore. The Causeway bus crossing takes 30-90 minutes each way depending on immigration queues. For families visiting LEGOLAND or Universal Studios Singapore, basing in JB and day-tripping into Singapore can save significant money. The trade-off is the daily Causeway queue."
  - question: "How do I cross from Johor Bahru to Singapore?"
    answer: "The Causeway (1km) connects JB Sentral to Woodlands, Singapore. Options: SBS Transit buses (SBS170, SMRT950 — SGD3.30 or RM3-5 each way), Rapid KL CW1 bus (RM3-5), or cross-border taxis. Pedestrians cannot walk across — you must take a bus. Immigration queues at busy times (Friday evenings, Monday mornings, public holidays) can extend to 2-3 hours. Crossing on a weekday mid-morning is the fastest option."
  - question: "Is LEGOLAND Malaysia worth visiting?"
