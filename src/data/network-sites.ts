...
export const NETWORK_SITES: NetworkSite[] = [
  ...
  { id: 'malaysia', name: 'Discover Malaysia', shortName: 'Malaysia', domain: 'discovermalaysia.info', url: 'https://discovermalaysia.info', flag: '\u{1F1F2}\u{1F1FE}', region: 'southeast-asia', status: 'live', tagline: 'Land Below the Wind' },
