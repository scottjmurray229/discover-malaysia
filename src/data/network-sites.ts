...
export const NETWORK_SITES: NetworkSite[] = [
  ...
  { id: 'malaysia', name: 'Discover Malaysia', shortName: 'Malaysia', domain: 'discoveringmalaysia.info', url: 'https://discoveringmalaysia.info', flag: '\u{1F1F2}\u{1F1FE}', region: 'southeast-asia', status: 'live', tagline: 'Land Below the Wind' },
...
export const CURRENT_SITE_ID = 'malaysia';
